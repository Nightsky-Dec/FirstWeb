...
public class User {
    private int uid;
    @NotNull(message = "{User.name.is.notnull}")
    private String name;
    @Size(min = 6,max = 12,message = "{User.pass.length.error}")
    private String pass;
    @Size(min = 6,max = 12,message = "{User.confPass.length.error}")
    private String confPass;
    private String email;
    @Size(min = 1,max = 3,message = "{User.age.length.error}")
    private String age;
